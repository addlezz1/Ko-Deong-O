...
class Sen2Page extends StatefulWidget {
  final List<Question> questions;
  final Unit unit;

  const Sen2Page({Key key, @required this.questions, this.unit}) : super(key: key);

  @override
  _QuizPageState createState() => _QuizPageState();
}

class _QuizPageState extends State<Sen2Page> {
