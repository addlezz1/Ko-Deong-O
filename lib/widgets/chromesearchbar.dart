  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      margin: EdgeInsets.fromLTRB(
        this.searchBorderRatio * 12.0,
        this.searchBorderRatio * 12.0,
        this.searchBorderRatio * 12.0,
        this.searchBorderRatio * 15.0,
      ),
      decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(
              this.searchBorderRatio * this.maxSearchBorder)),
      padding: EdgeInsets.fromLTRB(
          15.0 + 3.0 * (1 - this.searchBorderRatio),
          12.0 + 3.0 * (1 - this.searchBorderRatio),
          15.0 + 3.0 * (1 - this.searchBorderRatio),
          12.0 + 3.0 * (1 - this.searchBorderRatio)),
      child: Row(
