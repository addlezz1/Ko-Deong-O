...
class FavouriteButton extends StatefulWidget {
  ...
  const FavouriteButton(this.song,
      {Key key, this.size = 24.0, this.color, this.padding = 6.0})
      : super(key: key);
  @override
    ...
    return CupertinoButton(
        ...
        child: StreamBuilder(
            ...
            builder: (context, snapshot) {
              ...
              bool isLiked =
                  snapshot.data != null && snapshot.data.value != null;
              ...
              return CupertinoButton(
                  ...
                  child: isLiked
                      ? ImageIcon(
                          AssetImage("images/heartactive.png"),
                          size: widget.size,
                          color: Colors.red,
                        )
                      : ImageIcon(
